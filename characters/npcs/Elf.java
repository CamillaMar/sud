...
public class Elf extends Entity {
    ...
    public Elf(String name, String greetMessage) {
        ...
        setActualRoom(RoomMap.getRooms().get(dice.nextInt(ELF_POSSIBLE_ROOM)));
    }
    ...
    public void printArwenInstructions(){
        ...
        continueTheMessage();
        System.out.print("We wouldn't want to lose our hero so soon! Fairies are a perfect enemy to start fighting with!");
        continueTheMessage();
        ...
        continueTheMessage();
        System.out.print("Once you've trained with a few fairies, you can search for goblins here in the gardens without worrying about the guards!");
        continueTheMessage();
    ...
    public void printElrondFinalMessage(){
        isQuestOpen = false;
        System.out.println("PRESS ENTER TO CONTINUE READING.");
        delay(300);
        System.out.printf("%s says :" + BLUE + " Oh brave %s, welcome back!%n", getName(), player.getName());
        System.out.printf("Everyone at the market is talking highly about you... is it true what they say? Have you defeated the evil Smaug?%n" + RESET);
        delay(500);
        Item ring = player.getInventory().get("The One Ring");
        player.getInventory().remove("The One Ring");
        getInventory().put("The One Ring", ring);
        System.out.println("You have given the Ring to Elrond...");
        delay(500);
        System.out.printf(BLUE + "Oh my! The One Ring! You saved us!%n");
        continueTheMessage();
        System.out.printf("This town will be forever grateful to your braveness... Here, take this as an offer...%n" + RESET);
        player.pickItem(new Weapon("Golden Sword", 10));
        delay(500);
        System.out.print("Good luck for your next adventures, you will always be welcome here!");
        delay(500);
    }
